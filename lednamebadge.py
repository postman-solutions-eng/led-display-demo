...
# v0.3              jw  option -p to preload graphics added.
...
class SimpleTextAndIcons:
    ...
    bitmap_named = {
        ...
        'octocat': (array('B', (0x00, 0x3c, 0x42, 0x99, 0xa5, 0xa5, 0x99, 0x42, 0x3c, 0x00, 0x00)), 1, '\x13'),
        'smile': (array('B', (0x00, 0x3c, 0x42, 0xa5, 0xa5, 0xa5, 0x99, 0x42, 0x3c, 0x00, 0x00)), 1, '\x12'),
        'star': (array('B', (0x00, 0x10, 0x38, 0x7c, 0x38, 0x10, 0x7c, 0x38, 0x10, 0x00, 0x00)), 1, '\x11'),
        'sun': (array('B', (0x00, 0x10, 0x38, 0x54, 0x38, 0x10, 0x38, 0x54, 0x38, 0x10, 0x00)), 1, '\x10'),
    }
